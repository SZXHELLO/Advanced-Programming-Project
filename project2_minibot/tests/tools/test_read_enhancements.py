...
from minibot.agent.tools.filesystem import ReadFileTool, WriteFileTool
...
class TestReadDeviceBlacklist:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skipif(sys.platform == "win32", reason="/dev/zero symlink guard is POSIX-specific")
