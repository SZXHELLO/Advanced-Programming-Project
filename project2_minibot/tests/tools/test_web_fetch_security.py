...
from minibot.agent.tools.web import WebFetchTool
...
async def test_web_fetch_blocks_localhost():
    ...
    with patch("minibot.security.network.socket.getaddrinfo", _resolve_localhost):
...
async def test_web_fetch_blocks_private_redirect_before_returning_image(monkeypatch):
    ...
    monkeypatch.setattr("minibot.agent.tools.web.httpx.AsyncClient", FakeClient)
