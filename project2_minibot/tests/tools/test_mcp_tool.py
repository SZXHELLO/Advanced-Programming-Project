...
from minibot.agent.tools.mcp import (
    MCPResourceWrapper,
    MCPPromptWrapper,
    MCPToolWrapper,
    connect_mcp_servers,
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("minibot.agent.tools.mcp.logger.warning", _warning)
...
async def test_connect_mcp_servers_logs_stdio_pollution_hint(
    ...
    monkeypatch.setattr("minibot.agent.tools.mcp.logger.error", _error)
