...
from minibot.providers.openai_responses.converters import (
    convert_messages,
    convert_tools,
    convert_user_message,
    split_tool_call_id,
)
from minibot.providers.openai_responses.parsing import (
    consume_sdk_stream,
    map_finish_reason,
...
class TestParseResponseOutput:
    ...
    def test_malformed_tool_arguments_logged(self):
        ...
        with patch("minibot.providers.openai_responses.parsing.logger") as mock_logger:
            result = parse_response_output(resp)
