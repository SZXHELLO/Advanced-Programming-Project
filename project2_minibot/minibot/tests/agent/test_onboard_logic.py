...
from minibot.cli import onboard as onboard_wizard

# Import functions to test
from minibot.cli.commands import _merge_missing_defaults
from minibot.cli.onboard import (
    _BACK_PRESSED,
...
class TestProviderChannelInfo:
    ...
    def test_get_provider_names_returns_dict(self):
        from minibot.cli.onboard import _get_provider_names
    ...
    def test_get_channel_names_returns_dict(self):
        from minibot.cli.onboard import _get_channel_names
    ...
    def test_get_provider_info_returns_valid_structure(self):
        from minibot.cli.onboard import _get_provider_info
