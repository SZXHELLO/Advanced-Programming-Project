"""MCP client: connects to MCP servers and wraps their tools as native minibot tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a minibot Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only minibot Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only minibot Tool."""
