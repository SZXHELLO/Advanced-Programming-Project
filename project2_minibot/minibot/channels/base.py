...
class BaseChannel(ABC):
    ...
    to integrate with the minibot message bus.
    """
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        try:
            if self.transcription_provider == "openai":
                from minibot.providers.transcription import OpenAITranscriptionProvider
                provider = OpenAITranscriptionProvider(api_key=self.transcription_api_key)
            else:
                from minibot.providers.transcription import GroqTranscriptionProvider
