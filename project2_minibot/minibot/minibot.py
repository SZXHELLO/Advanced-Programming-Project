"""High-level programmatic interface to minibot."""
...
class Minibot:
    """Programmatic facade for running the minibot agent.
    ...
    def from_config(
        ...
        *,
        ...
        """Create a Minibot instance from a config file.
        ...
        """
        from minibot.config.loader import load_config, resolve_config_env_vars
