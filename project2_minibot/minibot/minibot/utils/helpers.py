...
_TOOL_RESULTS_DIR = ".minibot/tool-results"
...
def build_status_content(
    *,
    ...
    from minibot import __display_name__

    lines = [
        f"\U0001f408 {__display_name__} v{version}",
...
def sync_workspace_templates(workspace: Path, silent: bool = False) -> list[str]:
    ...
    try:
        from minibot.utils.gitstore import GitStore
