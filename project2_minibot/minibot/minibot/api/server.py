"""OpenAI-compatible HTTP API server for a fixed minibot session.
...
from minibot.utils.helpers import safe_filename
...
async def handle_chat_completions(request: web.Request) -> web.Response:
    ...
    model_name: str = request.app.get("model_name", "minibot")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "minibot")
    return web.json_response({
        "object": "list",
        "data": [
            {
...
def create_app(agent_loop, model_name: str = "minibot", request_timeout: float = 120.0) -> web.Application:
