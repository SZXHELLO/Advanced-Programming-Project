"""JSON Schema fragment types: all subclass :class:`~minibot.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~minibot.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~minibot.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~minibot.agent.tools.base.Schema`.
...
from minibot.agent.tools.base import Schema
