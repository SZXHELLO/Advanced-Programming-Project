...
from minibot.utils.helpers import build_status_content
from minibot.utils.restart import set_restart_notice_to_env
...
async def cmd_restart(ctx: CommandContext) -> OutboundMessage:
    ...
    async def _do_restart():
        ...
        os.execv(sys.executable, [sys.executable, "-m", "minibot"] + sys.argv[1:])
...
async def cmd_status(ctx: CommandContext) -> OutboundMessage:
    ...
    try:
        from minibot.utils.searchusage import fetch_search_usage
...
def build_help_text() -> str:
    ...
    lines = [
        f"{__logo__} {__display_name__} commands:",
